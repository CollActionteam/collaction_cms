...
import '../../application/crowdaction/crowdaction_getter/crowdaction_getter_bloc.dart'
    as _i15;
import '../../application/crowdaction/pagination/pagination_cubit.dart' as _i9;
import '../../domain/auth/i_auth_api_repository.dart' as _i10;
import '../../domain/auth/i_auth_client_repository.dart' as _i5;
import '../../domain/core/i_settings_repository.dart' as _i7;
import '../../domain/crowdaction/i_crowdaction_repository.dart' as _i12;
import '../auth/api/api_auth_repository.dart' as _i11;
import '../auth/firebase/firebase_auth_repository.dart' as _i6;
import '../crowdaction/crowdaction_repository.dart' as _i13;
import 'firebase_injectable.dart' as _i17;
import 'http_singleton.dart' as _i16;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i9.PaginationCubit>(() => _i9.PaginationCubit());
  gh.lazySingleton<_i10.IAuthApiRepository>(() => _i11.AuthApiRepository(
        get<_i3.Client>(),
        get<_i7.ISettingsRepository>(),
        get<_i5.IAuthClientRepository>(),
      ));
  gh.lazySingleton<_i12.ICrowdActionRepository>(
      () => _i13.CrowdActionRepository(
            get<_i3.Client>(),
            get<_i7.ISettingsRepository>(),
          ));
  gh.factory<_i14.AuthBloc>(() => _i14.AuthBloc(
        get<_i5.IAuthClientRepository>(),
        get<_i10.IAuthApiRepository>(),
      ));
  gh.factory<_i15.CrowdActionGetterBloc>(() => _i15.CrowdActionGetterBloc(
        get<_i12.ICrowdActionRepository>(),
        get<_i9.PaginationCubit>(),
      ));
  return get;
}

class _$HttpSingleton extends _i16.HttpSingleton {}
