...
class MapValidationOutput {
  MapValidationOutput({required this.error, required this.output});

  bool error;
  String output;
}

MapValidationOutput mapValidation(
    Either<ValueFailure<String>, String> domainValidationOutput) {
  late MapValidationOutput mapValidationOutput =
      MapValidationOutput(error: false, output: "");

  domainValidationOutput.fold((l) {
